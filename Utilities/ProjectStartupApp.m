classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Programming-Organizing-Data";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Programming: Organizing Data';
            ...
            app.ReviewTitle.Text = 'Welcome to Programming: Organizing Data';
